...
class ResPartnerAnafStatus(models.Model):
    ...
    _description = "ANAF History about company status active/inactive/closed"
    _order = "anaf_read_date desc"

    cui = fields.Integer(help="Just the number 1234 from vat like RO1234 ", index=True)
    data = fields.Date(index=True, help="The date for anaf interogation and data for validity of this record")
