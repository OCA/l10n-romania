...
class StockLandedCost(models.Model):
    ...
    def _prepare_landed_cost_vals(self, line, linked_layer, amount):
        return {
            "value": amount,
            "unit_cost": 0,
            "quantity": 0,
    ...
    def create_valuation_layers(self, line, linked_layer, amount):
        vals = self._prepare_landed_cost_vals(line, linked_layer, amount)
        valuation_layers = self.env["stock.valuation.layer"].create(vals)
        ...
        for cost in self:
            ...
            for line in cost.valuation_adjustment_lines.filtered(
                ...
                if not cost.company_id.currency_id.is_zero(cost_to_add):
                    new_valuation_layers = cost.create_valuation_layers(
                ...
                # Romania change: extract method to generate accountign entries
