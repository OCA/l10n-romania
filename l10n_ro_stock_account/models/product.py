...
class ProductTemplate(models.Model):
    ...
    def _get_product_accounts(self):
        ...
        # suplimentar la darea in consum mai face o nota contabila
            ...
            accounts["stock_output"] = l10n_ro_property_stock_usage_giving_account_id
            accounts["stock_input"] = l10n_ro_property_stock_usage_giving_account_id
            accounts["stock_valuation"] = l10n_ro_property_stock_usage_giving_account_id
        return accounts
