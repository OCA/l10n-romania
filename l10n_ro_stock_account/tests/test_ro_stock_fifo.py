...
class TestStockFifo(TestROStockCommon):
    ...
    def test_ro_search_remaining_qty_per_location(self):
        ...
        self.create_purchase({
            ...
            "qty": 5, "stock_qty": 5, "inv_qty": 5,
            "price": 100, "inv_price": 100,
            "index": "srq_po1",
        })
        ...
        self.assertIn(po1_move, results,
        ...
        self.create_sale_order({
            ...
            "product_id": self.product_fifo,
            "qty": 3, "stock_qty": 3, "inv_qty": 3,
            "price": 150, "inv_price": 150, "advance": 0, "discount": 0,
            "index": "srq_so1",
        })
        ...
        self.create_sale_order({
            ...
            "partner_id": self.customer_1,
            "product_id": self.product_fifo,
            "qty": 2, "stock_qty": 2, "inv_qty": 2,
            "price": 150, "inv_price": 150, "advance": 0, "discount": 0,
            "index": "srq_so2",
        })
        po1_move.invalidate_recordset(["remaining_qty"])
        results = search_remaining()
        self.assertNotIn(po1_move, results,
            "Fully consumed PO IN must NOT be in search results")
        ...
        results = search_remaining()
        self.assertIn(po2_move, results,
            "PO IN after compensation must be returned by search")
        self.assertAlmostEqual(po2_move.remaining_qty, 2.0,
