...
class StorageSheet(models.TransientModel):
    ...
    def do_compute_product(self):
        ...
        for location in all_locations:
            ...
            _logger.debug("start query_select_sold_init %s", location.name)
            ...
            _logger.debug("start query_select_sold_final %s", location.name)
    ...
    def _get_sql_select_in(self):
        ...
        WHERE
            ...
            sm.location_dest_id in %(locations)s AND
           (sm.l10n_ro_transfer_account_id IS NOT NULL OR sm.l10n_ro_account_id IS NOT NULL)
    ...
    def _get_sql_select_out(self):
        ...
        SELECT
            ...
            COALESCE(sm.l10n_ro_account_id, sm.l10n_ro_transfer_account_id) as account_id,
            NULL::int as invoice_id,
            sm.date as date_time,
            date_trunc('day', sm.date at time zone 'utc' at time zone %(tz)s) as date,
        ...
        WHERE
            ...
            (sm.l10n_ro_account_id IS NOT NULL OR sm.l10n_ro_transfer_account_id IS NOT NULL)
