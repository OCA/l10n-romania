...
class TestCiusRoXmlGeneration(CiusRoTestSetup):
    ...
    def get_attachment(self, move):
        move.with_context(force_report_rendering=True)._generate_pdf_and_send_invoice(template=self.move_template, force_synchronous=True, allow_fallback_pdf=True, bypass_download=False)
    ...
    def test_account_invoice_edi_ubl(self):
        ...
        self._assert_invoice_attachment(att, xpaths=None, expected_file_path='invoice.xml')
    ...
    def test_account_credit_note_edi_ubl(self):
        ...
        self._assert_invoice_attachment(att, xpaths=None, expected_file_path='credit_note.xml')
    ...
    def test_account_credit_note_with_option_edi_ubl(self):
        ...
        self.credit_note.action_post()
        att = self.get_attachment(self.credit_note)
        self._assert_invoice_attachment(att, xpaths=None, expected_file_path='credit_note_option.xml')
    ...
    def test_account_invoice_in_edi_ubl(self):
        ...
        self._assert_invoice_attachment(att, xpaths=None, expected_file_path='invoice_in.xml')
    ...
    def test_account_credit_note_in_edi_ubl(self):
        ...
        self._assert_invoice_attachment(att, xpaths=None, expected_file_path='credit_note_in.xml')
    ...
    def test_account_credit_note_in_with_option_edi_ubl(self):
        ...
        self.credit_note_in.action_post()
        att = self.get_attachment(self.credit_note_in)
        self._assert_invoice_attachment(att, xpaths=None, expected_file_path='credit_note_in_option.xml')
