...
<xsl:stylesheet version="1.0"
	...
	<xsl:template name="stylesheet">
				...
				<paraStyle name="normal" fontName="Helvetica" fontSize="5.5" alignment="CENTER"/>
...
<!--		<tr></tr>-->
		<tr>
			...
			<xsl:for-each select="day">
				<td>
					<para style="normal"><xsl:value-of select="wh"/></para>
					<para style="normal"><xsl:value-of select="ng"/></para>
				</td>
			</xsl:for-each>
		</tr>
