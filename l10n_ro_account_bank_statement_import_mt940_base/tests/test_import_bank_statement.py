...
class TestImport(TestMT940BankStatementImport):
    ...
    transactions = [
        {
            ...
            'amount': -34.61,
            'payment_ref': '/Periode 01-10-2013 t/m 31-12-2013',
            'ref': 'NONREFNL46ABNA0499998748'
        },
    ]
    ...
    def setUp(self):
        ...
        self.bank = self.create_partner_bank('NL34RABO0142623393')
    ...
    def test_statement_import(self):
        ...
        for line in statement.line_ids:
            ...
            self.assertTrue(line.date == fields.Date.from_string('2014-01-01'))
