...
class TestTrialBalanceReport(common.TransactionCase):
    def setUp(self):
        ...
        self.group1 = group_obj.create({"code_prefix": "899", "name": "Group 8"})
        self.group2 = group_obj.create(
            {"code_prefix": "89998", "name": "Group 89998", "parent_id": self.group1.id}
        )
        self.group3 = group_obj.create({"code_prefix": "999", "name": "Group 999"})
