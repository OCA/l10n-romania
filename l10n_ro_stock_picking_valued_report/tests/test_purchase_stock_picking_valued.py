...
class TestPurchaseStockPickingValued(TestStockPickingValued):
    ...
    def test_03_tax_rounding_method(self):
        ...
        for picking in self.purchase_order.picking_ids:
            ...
            self.assertEqual(picking.amount_tax, 19.0)
            self.assertEqual(picking.amount_total, 119.0)
    ...
    def test_04_lines_distinct_tax(self):
        ...
        for picking in self.purchase_order2.picking_ids:
            ...
            self.assertEqual(picking.amount_untaxed, 600.0)
            self.assertEqual(picking.amount_tax, 114.0)
            self.assertEqual(picking.amount_total, 714.0)
    ...
    def test_05_distinct_qty(self):
        ...
        for picking in self.purchase_order.picking_ids:
            ...
            self.assertEqual(picking.amount_tax, 38.0)
            self.assertEqual(picking.amount_total, 238.0)
    ...
    def test_06_po_currency_qty(self):
        ...
        exp = {
            ...
            % line_key: {
                ...
                "price_tax": 19.0,
                "price_total": 119.0,
                "currency_id": move_line.company_id.currency_id.id,
            }
        }
