...
class HRInsuranceType(models.Model):
    ...
    type = fields.Selection("_get_insurance_type", string="Type", help="Insurance type")
...
class HRContract(models.Model):
    ...
    pensioneer = fields.Boolean("Pensioneer", help="Is the employee a pensioneer")
    ...
    work_hour = fields.Selection(
        "_get_work_hours", string="Hour per day", help="The numbers of hours/day"
    )
    work_type = fields.Selection(
        "_get_work_type", string="Work type", help="The work type based on conditions"
    )
    insurance_type = fields.Many2one(
        "hr.insurance.type", string="Insurance type", help="Insurance type"
    )
